...
<body>
  ...
  <section class="culture-hero" style="background-image: url('./img/Bottom view of diverse multiracial people stand in….jpg');">
    ...
    <div class="hero-content">
      ...
      <p>Understanding the unspoken rules of teamwork in Japan</p>
    </div>
  </section>
  ...
  <main class="culture-content">
    <section class="card-style-section">
      ...
      <p>
        If you're a non-Japanese person working or studying in Japan, here are some tips to navigate group harmony:
      </p>
      <ul>
        <li>Listen carefully and observe group dynamics before speaking.</li>
