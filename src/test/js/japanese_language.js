...
// =========================================
Promise.all([
    fetch('./js/translations/japanese_language-ja.json').then(response => response.json()),
    fetch('./js/translations/japanese_language-zh.json').then(response => response.json())
])
.then(([jaData, zhData]) => {
