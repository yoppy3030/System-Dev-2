...
// 翻訳データの読み込み
Promise.all([
    fetch('./js/translations/language_expectations-ja.json').then(response => response.json()),
    fetch('./js/translations/language_expectations-zh.json').then(response => response.json())
])
.then(([jaData, zhData]) => {
