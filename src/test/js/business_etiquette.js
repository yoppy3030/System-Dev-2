...
// 翻訳データの読み込み
Promise.all([
    fetch('./js/translations/business_etiquette-ja.json').then(response => response.json()),
    fetch('./js/translations/business_etiquette-zh.json').then(response => response.json())
])
.then(([jaData, zhData]) => {
