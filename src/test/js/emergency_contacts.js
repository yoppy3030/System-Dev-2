...
// =========================================
Promise.all([
    fetch('./js/translations/emergency_contacts-ja.json').then(response => response.json()),
    fetch('./js/translations/emergency_contacts-zh.json').then(response => response.json())
])
.then(([jaData, zhData]) => {
