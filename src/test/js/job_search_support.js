...
// =========================================
Promise.all([
    fetch('./js/translations/job_search_support-ja.json').then(response => response.json()),
    fetch('./js/translations/job_search_support-zh.json').then(response => response.json())
])
.then(([jaData, zhData]) => {
