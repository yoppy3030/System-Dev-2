...
<main class="content">
  <h1>💳 IC Cards</h1>
  <p>Learn how to use IC cards like Suica and Pasmo for convenient travel across Japan’s rail and bus systems.</p>

  <section class="steps">
    <div class="step">
      <h2>1️⃣ What are IC Cards?</h2>
